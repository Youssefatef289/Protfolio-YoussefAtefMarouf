...
export function PerspectiveCarousel({
  ...
  }, [autoplay, autoplayInterval, currentIndex, items.length, selectSlide]);
              ...
              >
                ...
                >
                  <button
                    ...
                    className={cn("w-full cursor-pointer bg-transparent", aspectClassName)}
                  ...
                  {isActive && item.demoUrl && item.demoUrl !== "#" && (
                    <motion.div
                    ...
                    >
                      <DemoButton
                        href={item.demoUrl}
                        label={item.demoLabel ?? "View Demo"}
                      />
                    </motion.div>
                  )}
                </motion.div>
