...
const Footer: FC = () => {
  ...
  return (
    <footer className='border-t border-sky-200/15 bg-[#081738] text-primary '>
      <div className='container mx-auto max-w-6xl px-4 py-12'>
        {/* Main Footer Content */}
        <div className='grid md:grid-cols-3 gap-8 mb-8'>
          {/* Logo & Name */}
          <div className='text-center md:text-left'>
            <Link href='/' className='inline-flex items-center justify-center mb-4' aria-label='Youssef Atef home'>
              <Image
                ...
                height={64}
                quality={100}
                className='h-20 w-100 rounded-xl object-contain drop-shadow-sm mx-auto'
                priority
              />
            </Link>
