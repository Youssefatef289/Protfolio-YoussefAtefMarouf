...
export const count = [
    {
        ...
        value: "7+",
        description: "Projects completed for clients across different industries",
    },
    {
        icon: getImgPath("/images/counter/admin.svg"),
        value: "20+",
        description: "Websites and landing pages designed & developed",
    },
    {
        icon: getImgPath("/images/counter/bag.svg"),
        value: "100%",
        description: "Client satisfaction with every delivered project",
    },
];
...
export const Skills = [
    ...
    { name: 'WordPress', icon: 'logos:wordpress-icon', progress: 85 },
...
export const portfolioinfo: PortfolioProject[] = [
    {
        ...
        slug: 'al-hafni-farms',
        info: 'Fresh Meats, Poultry & Dairy',
    ...
    },
    {
        ...
        alt: 'Al-Geheny Real Estate',
        title: 'Al-Geheny Real Estate',
        slug: 'al-geheny',
        info: 'Real Estate Development',
    ...
    },
    {
        ...
        info: 'Premium Meat & Delicatessen',
        demoUrl: 'https://al-mustafa-meats.vercel.app/',
        technologies: ['React', 'Next.js', 'TypeScript'],
        Class: 'md:mt-24'
    },
    {
        image: getImgPath('/images/portfolio/Al-Umara Real Estate Development.png'),
        alt: 'Al-Umara for Development',
        title: 'Al-Umara for Development',
        slug: 'al-umaraa-for-development',
        info: 'Real Estate Development',
    ...
    },
    {
        ...
        title: 'Emaar Company',
        slug: 'emaar-company',
        info: 'Real Estate Development & Marketing',
